...
/* Tests the libfsrefs_ministore_tree_get_number_of_block_descriptors function
 * Returns 1 if successful or 0 if not
 */
int fsrefs_test_ministore_tree_get_number_of_block_descriptors(
     void )
{
	libcerror_error_t *error                   = NULL;
	libfsrefs_ministore_tree_t *ministore_tree = NULL;
	...
	/* Test regular cases
	 */
	result = libfsrefs_ministore_tree_get_number_of_block_descriptors(
	          ministore_tree,
...
#endif
{
	...
	FSREFS_TEST_RUN(
	 "libfsrefs_ministore_tree_get_number_of_block_descriptors",
	 fsrefs_test_ministore_tree_get_number_of_block_descriptors );

	/* TODO: add tests for libfsrefs_ministore_tree_get_block_descriptor_by_index */

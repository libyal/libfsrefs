...
typedef struct fsrefstools_option fsrefstools_option_t;

struct fsrefstools_option
{
...
void fsrefstools_getopt_wrapped_fprint(
      FILE *stream,
...
void fsrefstools_getopt_usage_fprint(
      FILE *stream,
      const char *program,
      const char *description,
      const fsrefstools_option_t *options,
      int number_of_options );

int fsrefstools_getopt_get_options_string(
     const fsrefstools_option_t *options,
     int number_of_options,
